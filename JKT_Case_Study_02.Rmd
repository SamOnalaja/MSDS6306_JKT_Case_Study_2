...
#attrition%>%ggplot() +
#  geom_histogram(aes(x=JobInvolvement, fill= Attrition), bins =4, color='black', position="stack")+
#  scale_fill_manual(values=c("Yes"="red","No"="dark green"))+
#  ggtitle(label='The Effect of Job Involvement on Attrition by Count')

#attrition%>%ggplot(aes(JobInvolvement, fill= Attrition)) +
#  geom_histogram(aes(y=(..count..)/sum(..count..)), bins =4, color ='black', position="fill")+
#  scale_fill_manual(values=c("Yes"="red","No"="dark green"))+
